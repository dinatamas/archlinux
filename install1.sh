...
packagelist+=" networkmanager acpilight"
...
packagelist+=" tmux qbittorrent xclip"
packagelist+=" powerline nitrogen xcompmgr ntfs-3g gvfs-mtp"
packagelist+=" docker jq atom re2 thunar gparted"
packagelist+=" alsa-utils pavucontrol pciutils pulseaudio usbutils"
packagelist+=" gnu-free-fonts i3 picom rofi xorg-server xorg-xinit xorg-xrandr"
packagelist+=" firefox xterm-unicode vlc flameshot"
